package com.bkw.library;


import com.bkw.library.deserializer.ObjectDeserializer;
import com.bkw.library.serializer.JSONSerializer;
import com.bkw.library.serializer.SerializeConfig;
...
public class JSON {
    ...
    public static <T> T parseObject(String json, Class<T> clazz) {
        return parseObject(json, clazz, SerializeConfig.GLOBAL_INSTANCE);
    }
